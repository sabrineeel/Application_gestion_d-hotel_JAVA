...
public class Page8 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        boolean reservationAdded = user.addReservation(startDate, endDate, roomType, roomModel, numberOfAdults, numberOfChildren);
    
        // Afficher une boîte de dialogue en fonction du résultat de l'ajout de la réservation
        if (reservationAdded) {
            JOptionPane.showMessageDialog(this, "La réservation a été ajoutée avec succès.");
        } else {
            JOptionPane.showMessageDialog(this, "Erreur lors de l'ajout de la réservation. Veuillez réessayer.");
        }
    }
