...
public class Admin {
    ...
    public Admin(String username,String passwrod,String firstname, String lastename, Date dateofBirth, String mail, String adresse,
    String phoneNumber,String adminRole,ArrayList<Reservation> reservationList, ArrayList<Room> roomList,ArrayList<Client> clientList) {
    ...
    private boolean checkReservationConflict(Reservation newreservation) {
