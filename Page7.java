...
public class Page7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/photo/add_circle_create_expand_new_plus_icon_123218.png"))); // NOI18N
        jButton8.setText("ADD Reservation ");
        ...
        jButton8.setBounds(20, 380, 350, 50);

        jButton9.setBackground(new java.awt.Color(241, 228, 203));
        jButton9.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/photo/about_3697.png"))); // NOI18N
        ...
        getContentPane().add(jButton9);
            jButton9.setBounds(20, 460, 350, 50);
    
            jButton10.setBackground(new java.awt.Color(241, 228, 203));
            jButton10.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
            jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/photo/4115235-exit-logout-sign-out_114030.png"))); // NOI18N
            ...
            jButton10.setBounds(20, 540, 350, 50);
            ...
            jComboBox7.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        jComboBox9.setFont(new java.awt.Font("Times New Roman",1, 24)); // NOI18N
        ...
        jComboBox10.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jComboBox10.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Adult", "Adult+1", "Adult+2", "Adult+3" }));
        ...
        jButton1.setBounds(866, 400, 220, 37);

        jComboBox11.setBackground(new java.awt.Color(241, 228, 203));
        jComboBox11.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        jComboBox12.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        jComboBox13.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ssh/hotel/photo/cancel.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        boolean reservation = user.deleteReservation(x,startDate);
                // Afficher une boîte de dialogue en fonction du résultat de la suppression
                if (reservation) {
                    JOptionPane.showMessageDialog(this, "La réservation avec   a été supprimée avec succès.", "Suppression réussie", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, "La réservation n'a pas pu être supprimée.", "Erreur de suppression", JOptionPane.ERROR_MESSAGE);
                }
            } 
